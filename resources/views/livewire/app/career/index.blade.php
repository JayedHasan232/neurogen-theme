        ...
        <div class="col-md-4">
            <div class="research">
                <div class="informations">
                    ...
                    <small class="date">Deadline: {{ $career->date }}</small>
                    <p class="overview">{{ Str::limit(strip_tags($career->article), 150, '...') }}</p>
                </div>
                <div class="link-group">
                    <a href="{{ route('app.career.show', $career->url) }}" class="link" target="_blank">
                        Read More
                    ...
                    @auth()
                        @if(Auth::user()->role != 0)
                            <a href="{{ route('admin.career.edit', $career->id) }}" class="link" title="Only admin or modarator can see this." target="_blank">
