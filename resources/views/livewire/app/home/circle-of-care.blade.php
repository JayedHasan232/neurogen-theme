    ...
    <div class="{{ env('BS_CONTAINER') }}">
        ...
        <div class="row g-4">
            @foreach($services as $service)
                @if($service->url == "genetic-test" || $service->url == "deep-clinical-assessment" || $service->url == "behavior-modification-therapy" || $service->url == "speech-and-language-therapy" || $service->url == "occupational-therapy" || $service->url == "physiotherapy")
