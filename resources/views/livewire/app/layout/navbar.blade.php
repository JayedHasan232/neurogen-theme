        ...
        <div class="{{ env('BS_CONTAINER') }}">
            ...
            <ul class="navbar-nav d-none d-md-flex">
                <li class="nav-item">
                    ...
                    <ul class="submenu">
                        <li class="sm-item">
                            <a class="sm-link" href="{{ route('app.welcome') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" href="#">{{ __('Healthcare Service') }}</a>
                    <ul class="submenu">
                        <li class="sm-item">
                            <a class="sm-link" href="{{ route('app.welcome') }}">{{ __('Clinics') }}</a>
                            <ul class="childmenu">
                                <li class="cm-item">
                                    <a class="cm-link" href="{{ route('app.welcome') }}">{{ __('Clinics') }}</a>
                                </li>
                                <li class="cm-item">
                                    <a class="cm-link" href="{{ route('app.welcome') }}">{{ __('Genetics and Genomic Medicine Centre') }}</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sm-item">
                            <a class="sm-link" href="{{ route('app.welcome') }}">{{ __('Genetics and Genomic Medicine Centre') }}</a>
                            <ul class="childmenu">
                                <li class="cm-item">
                                    <a class="cm-link" href="{{ route('app.welcome') }}">{{ __('Clinics') }}</a>
                                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('app.research.index') }}">{{ __('Research') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('app.blog.index') }}">{{ __('Blog') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" href="{{ route('app.gallery.index') }}">{{ __('Gallery') }}</a>
                    <ul class="submenu">
                        <li class="sm-item">
                            <a class="sm-link" href="{{ route('app.gallery.index', 'images') }}">
                        ...
                        <li class="sm-item">
                            <a class="sm-link" href="{{ route('app.gallery.index', 'videos') }}">
