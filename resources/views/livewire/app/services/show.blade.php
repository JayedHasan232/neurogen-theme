        ...
        <div class="{{ env('BS_CONTAINER') }}">
            <div class="row">
                ...
                <div class="col-md-5 order-md-1">
                    ...
                    @auth
                        @if(Auth::user()->role == 1)
                        <a href="{{ route('admin.services.edit', $service->id) }}" class="btn btn-accent mt-5 rounded-pill" title="Only Admin can see this."><i class="fas fa-edit mr-1"></i>Edit</a>
                        @endif
                    @endauth
            ...
            <div class="col-sm-6 col-md-4">
                <div class="blog-post">
                    ...
                    <div class="link-group">
                        ...
                        @auth()
                            @if(Auth::user()->role != 0)
                                <a href="{{ route('admin.services.edit', $service->id) }}" class="link" title="Only admin or modarator can see this." target="_blank">
